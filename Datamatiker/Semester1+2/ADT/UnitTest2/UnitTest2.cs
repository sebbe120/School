...
namespace UnitTest2
{
    ...
    public class UnitTest2
    {
        ...
        {
            LinkedListOfT<ClubMember> list = new LinkedListOfT<ClubMember>();
        ...
        [TestMethod]
        public void TestGenericPrepend()
        {
            LinkedListOfT<ClubMember> list = new LinkedListOfT<ClubMember>();
            list.Prepend(p5);  // p5
            list.Prepend(p21); // p21,p5
            list.Prepend(p9);  // p9,p21,p5
            list.Prepend(p24); // p24,p9,p21,p5
        ...
        [TestMethod]
        public void TestGenericMixedPrepends()
        {
            LinkedListOfT<ClubMember> list = new LinkedListOfT<ClubMember>();
            list.Prepend(p3); // p3
            list.Append(p22); // p3,p22
            list.Prepend(p9); // p9,p3,p22
            list.Prepend(p1); // p1,p9,p3,p22
            list.Append(p24); // p1,p9,p3,p22,p24
            list.Prepend(p5); // p5,p1,p9,p3,p22,p24
        ...
        [TestMethod]
        public void TestGenericMixedPrependsAndRemoves()
        {
            LinkedListOfT<ClubMember> list = new LinkedListOfT<ClubMember>();
            list.Prepend(p3); // p3
            list.Append(p22); // p3,p22
            ...
            list.Prepend(p1); // p1,p3,p22
            list.Append(p24); // p1,p3,p22,p24
            list.Prepend(p5); // p5,p1,p3,p22,p24
        ...
        {
            // ** int list test *********
            LinkedListOfT<int> listInt = new LinkedListOfT<int>();
        ...
        {
            // ** string list test **********
            LinkedListOfT<string> listString = new LinkedListOfT<string>();
        ...
        {
            // ** decimal list test ***********
            LinkedListOfT<decimal> listDecimal = new LinkedListOfT<decimal>();
