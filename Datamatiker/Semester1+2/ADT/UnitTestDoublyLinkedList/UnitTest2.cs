...
namespace UnitTest2
{
    ...
    public class UnitTest2
    {
        ...
        {
            DoublyLinkedListOfT<ClubMember> list = new DoublyLinkedListOfT<ClubMember>();
        ...
        [TestMethod]
        public void TestGenericMixedInsertFirsts()
        {
            DoublyLinkedListOfT<ClubMember> list = new DoublyLinkedListOfT<ClubMember>();
        ...
        [TestMethod]
        public void TestGenericMixedInsertFirstsAndRemoves()
        {
            DoublyLinkedListOfT<ClubMember> list = new DoublyLinkedListOfT<ClubMember>();
            list.InsertFirst(p3); // p3
            list.InsertLast(p22); // p3,p22
        ...
        {
            // ** int list test *********
            DoublyLinkedListOfT<int> listInt = new DoublyLinkedListOfT<int>();
        ...
        {
            // ** decimal list test ***********
            DoublyLinkedListOfT<decimal> listDecimal = new DoublyLinkedListOfT<decimal>();
